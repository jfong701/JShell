...
/**
 * Custom Exception raised when a DirectoryStack is Empty and an attempt to pop
 * it is made.
 * 
...
public class EmptyDirectoryStackException extends Exception {
  ...
  public EmptyDirectoryStackException() {
    super("The DirectoryStack is empty," + " cannot pop a Folder from it.");
  }
   ...
   */
  public EmptyDirectoryStackException(Throwable cause) {
    super(cause);
  }
   ...
   * @param cause name of Exception object to be created
   */
  public EmptyDirectoryStackException(String message, Throwable cause) {
    super(message, cause);
  }
