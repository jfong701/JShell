...
public class InvalidNumberOfArgument extends Exception {
  /**
   * Construct an Exception Object which fills in a default string message.
   */
  public InvalidNumberOfArgument() {
    super("Invalid number of parameters/arguments were given.");
  }
   ...
   */
  public InvalidNumberOfArgument(String message) {
    super(message);
  }
   ...
   */
  public InvalidNumberOfArgument(Throwable cause) {
    super(cause);
  }
   ...
   * @param cause name of Exception object to be created
   */
  public InvalidNumberOfArgument(String message, Throwable cause) {
    super(message, cause);
  }
