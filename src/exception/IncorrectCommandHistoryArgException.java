...
/**
 * Custom Exception that can be raised by passing in a non-integer type in
 * history command
 * 
 * @author Kevin Bato
 *
 */
public class IncorrectCommandHistoryArgException extends Exception {

  /**
   * Construct an Exception Object which fills in a default string message.
   */
  public IncorrectCommandHistoryArgException() {
    super("Numeric argument needed for \"history\" command");
  }
   ...
   */
  public IncorrectCommandHistoryArgException(String message) {
    super(message);
  }
   ...
   */
  public IncorrectCommandHistoryArgException(Throwable cause) {
    super(cause);
  }
   ...
   * @param cause name of Exception object to be created
   */
  public IncorrectCommandHistoryArgException(String message, Throwable cause) {
    super(message, cause);
  }
